  ...
  return (
    <>
      ...
      <div className="card">
        ...
        <p className="hint">
          แก้ค่าแล้วมีผลกับการคำนวณรอบถัดไปทันที รอบที่คำนวณไปแล้วเก็บค่าเดิมไว้ ตรวจย้อนหลังได้
          <br />
          <strong>include_class_a / b / c</strong> — ใส่ 1 เพื่อนำคลาสนั้นมาคำนวณ ใส่ 0 เพื่อข้าม
        </p>
        <table>
          <tbody>
            {settings.map((s) => (
